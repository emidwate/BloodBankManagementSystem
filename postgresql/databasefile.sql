...
DROP TABLE IF EXISTS private_facility CASCADE;
DROP TABLE IF EXISTS donor CASCADE;
DROP TABLE IF EXISTS donor_medical CASCADE;
DROP TABLE IF EXISTS patient CASCADE;
DROP TABLE IF EXISTS patient_medical CASCADE;
DROP TABLE IF EXISTS blood_transfusion CASCADE;
...
CREATE TABLE donor_medical (
  donor_medical_id SERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE patient_medical (
  patient_medical_id SERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE blood_transfusion (
  transfusion_id SERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE blood_donations (
  blood_donations_id SERIAL PRIMARY KEY NOT NULL,
...
ALTER TABLE donor_medical
  ADD CONSTRAINT fk_donor_medical_donor FOREIGN KEY (donor_id) REFERENCES donor (donor_id) ON DELETE CASCADE,
  ADD CONSTRAINT fk_donor_medical_blood FOREIGN KEY (blood_type) REFERENCES blood (blood_type) ON DELETE CASCADE;

ALTER TABLE blood_donations
  ADD CONSTRAINT fk_donations_private_facility FOREIGN KEY (private_facility_id) REFERENCES private_facility (facility_id) ON DELETE CASCADE,
  ADD CONSTRAINT fk_donations_hospital FOREIGN KEY (hospital_id) REFERENCES hospital (hospital_id) ON DELETE CASCADE,
  ADD CONSTRAINT fk_donations_donor_medical FOREIGN KEY (donor_medical_id) REFERENCES donor_medical (donor_medical_id) ON DELETE CASCADE;

ALTER TABLE blood_transfusion
  ADD CONSTRAINT fk_transfusion_patient_medical FOREIGN KEY (patient_medical_id) REFERENCES patient_medical (patient_medical_id) ON DELETE CASCADE,
  ADD CONSTRAINT fk_transfusion_private_facility FOREIGN KEY (private_facility_id) REFERENCES private_facility (facility_id) ON DELETE CASCADE,
  ADD CONSTRAINT fk_transfusion_hospital FOREIGN KEY (hospital_id) REFERENCES hospital (hospital_id) ON DELETE CASCADE;

ALTER TABLE patient_medical
  ADD CONSTRAINT fk_patient_medical_patient FOREIGN KEY (patient_id) REFERENCES patient (patient_id) ON DELETE CASCADE,
  ADD CONSTRAINT fk_patient_medical_blood FOREIGN KEY (blood_type) REFERENCES blood (blood_type) ON DELETE CASCADE;
